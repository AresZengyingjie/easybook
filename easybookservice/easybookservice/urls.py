"""easybookservice URL Configuration
...
urlpatterns = [
	...
	url(r'^deletebook/(?P<bookid>\w*)/(?P<username>\w*)/$', 'books.views.deletebook'),
	...
	url(r'^hospitalInfor/(?P<username>\w*)/(?P<hosptalid>\d*)/(?P<proid>\d*)/$', 'hospital.views.selectdoc2'),
