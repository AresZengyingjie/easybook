    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospitalid', models.CharField(max_length=10, verbose_name=b'id')),
                ('name', models.CharField(max_length=50, verbose_name=b'name')),
                ('level', models.CharField(max_length=10, verbose_name=b'level')),
                ('quality', models.CharField(max_length=10, verbose_name=b'quality')),
                ('classes', models.CharField(max_length=10, verbose_name=b'classes')),
