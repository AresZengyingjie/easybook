...
def addadvice(request,username):
	...
	user.advice_set.create(hos_id = hos.hospitalid, dep = dep, recommend = recommend, treatmentEffect = treatmentEffect, docAttitude = docAttitude, disease = disease ,doctor = doctor,context = context, tel = tel)
